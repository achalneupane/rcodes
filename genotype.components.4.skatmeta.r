...
########
cancer.group<-"AML" # columns names in pheno.ori used to get samples 
control.group<-"Control" # columns names in pheno.ori used to get samples 
PD.group<-c("AML-Child","Asian-AML-Child","Asian-AML","AML-NotDiagnosis-Child","Asian-AML-NotDiagnosis-Child") # columns names in pheno.ori used to get samples boolean are stored there 
