...
Sample.name <-"ALL" # c("NSGC-9.3","SKDP-55.3","SKDP-6.1") # "ALL" use "ALL" is want to get all in the /media/UQCCG/Sequencing/Projects/SKDP directory!
...
out.file<- "/media/scratch/Aideens_program/Paul.txt"
