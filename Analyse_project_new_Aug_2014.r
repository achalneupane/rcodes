...
#### project<-"2014-08-06_SKDP_SDDS_UG" # this is the project directory
...
# the.sample.sheet<-"/media/UQCCG/Sequencing/Data/Sequence_Genotypes/2014-08-06_SKDP_SDDS_UG/BAM/SDDS_AffStatus.csv"
...
filter.cols.maf<-c("PopFreqMax","NHBLI_6500_ANNOVAR_ALL","NHBLI_6500_ALL","NHBLI_6500_EA","NHBLI_6500_AA","NHLBI_5400_ALL","1000genome","snp141","snp137")
