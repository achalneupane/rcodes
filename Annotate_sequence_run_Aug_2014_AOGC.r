...
UQCCG.data<-"/media/UQCCG/UQCCG-Projects/AOGC_exome_chip"
project <-"working_genotypes"  ### bim file that is the superset of all genotypes
project.name<-"recode_sampleNames_zCall_AOGC.with.evoker_corrected_clean_FINAL"
...
print(paste(" UQGGC.data-> ",UQCCG.data, ", project-> ",project,", chr-> ",ichr,sep=" "))
#q()
...
##########
vcf.type="bim" # "annovar" "v4" "v3" "plink_assoc"
#########
...
####
snp.files<-"recode_sampleNames_zCall_AOGC.with.evoker_corrected_clean_FINAL.bim"
...
print(sample.files)
#} ## "TGCM-AML"
sample.files<-"recode_sampleNames_zCall_AOGC.with.evoker_corrected_clean_FINAL.bim"
names(sample.files)[i]<-variant.types[i]
...
print(paste("Reading in vcf genotypes:-> ",UQCCG.data, ", project-> ",project,", chr-> ",ichr,sep=" "))
setwd(code.dir)
