...
genome.build<-"hg18"
plot.dir<-"/media/old-scratch/media/scratch2/Uveitis"
work.dir<-"/media/old-scratch/media/scratch2/Uveitis"
rates.dir<-"/media/UQCCG/GWAS/Recombination_Rates/Recombination Rates_hg18" ##genetic_map_chr1_b36.txt
...
the.gene <- 20 # tag used to do adjustments
 the.chr<-10 ; the.snp<-"" ; low.cut<-19020000    ; high.cut<-19200000   ; left.side=FALSE; ymax.range=6; recomb.high=40
###############################################
...
plot.name<-"African_cond.rs16981277,chr19.5022"
...
with.conservation<-FALSE
the.gene <- 20 # tag used to do adjustments
 the.chr<-19 ; the.snp="" ; low.cut<-49850000   ; high.cut<-50475000  ; left.side=FALSE; ymax.range=6; recomb.high=40 ; target.gene<-"BCL2L12" # the.snp<-"rs16981277"

label.snps<-c("rs16981277","rs11880051", "rs58705717","rs2060263","rs58705717","chr19:50228271:I")
...
source("/media/UQCCG/Programming/VersionControl_GitRepository/UQCCG_Pipeline_Rscripts/get_data_4_locus_data.r")
...
source("/media/UQCCG/Programming/VersionControl_GitRepository/UQCCG_Pipeline_Rscripts/make_locusZomm_plot.r")
...
imput[loc,"SNP"]
"rs16981277" "rs58705717","rs2060263","chr19:50228271:I"

"rs2060263"  "rs58705717"

conidition<-c("rs16981277","chr19:50228271:I")

write.table(conidition,file="condition.list.txt",col.names=FALSE,row.names=FALSE,sep="\t",quote=FALSE) 

system("
 plink --bfile hapmap3_1000G_BCL2L12_1Mbp --condition-list condition.list.txt --covar African_PCA.evecs --covar-name PC1,PC2 --geno 0.05 --maf 0.01 --keep African.fam --linear hide-covar  --out BCL2L12_African_cond.rs16981277,chr19.5022
