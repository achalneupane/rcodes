...
## the.sample.sheet<-"/mnt/UQCCG/Sequencing/Data/Sequence_Genotypes/2014-05-13_SKDP_LGCA/BAM/140424_SN989_0195_BC4LV1ACXX_SampleSheet_Aideen_input.csv"
...
#UQCCG.data<-"/home/mmarshall/PBSHOME/HiSeq/genotyping"
UQCCG.data<-"/media/UQCCG/Sequencing/Data/Sequence_Genotypes/2014-03-19_MND_MODY_LKAF_Nimbelgen/Analysis/"
project<-"2014-03-19_MND_MODY_LKAF_Nimbelgen.Ch_MND_F.wanted.All-maf-filtered.txt"
project.name <- project
annotate.dir <-paste(UQCCG.data,project,"Annotate",sep="/")
analysis.dir<-paste(UQCCG.data,project,"Analysis",sep="/")
...
annotate.dir<-"/mnt/UQCCG/Sequencing/Data/Sequence_Genotypes/2014-03-19_MND_MODY_LKAF_Nimbelgen/AnalysisAnnotate" # dir(annotate.dir)
analysis.dir<-"/mnt/UQCCG/Sequencing/Data/Sequence_Genotypes/2014-03-19_MND_MODY_LKAF_Nimbelgen/AnalysisAnalysis" # dir(analysis.dir)
project.extension<-".analysis-maf-filtered.txt" # ".analysis-maf-filtered.txt"   ".analysis-maf-filtered.txt.geno.all.txt"  ## just the exterion not fam.extension! ".analysis-maf-filtered.txt.geno.all.txt" #
project.name<-"20131115_GroupCallSKDP_MODY_PCC_ChMND"
fam<-c("SKDP-172") #  ALL or  all ""-one project (the prefix of the summary files to collect
the.sample.sheet<-"/media/UQCCG/Sequencing/Data/Sequence_Genotypes/2014-03-19_MND_MODY_LKAF_Nimbelgen/BAM/Ch_MND_SampleSheet.csv"
/media/UQCCG/Sequencing/Data/Sequence_Genotypes/2014-03-19_MND_MODY_LKAF_Nimbelgen/Analysis/2014-03-19_MND_MODY_LKAF_Nimbelgen.chrY.Ch_MND_F.analysis.txt
remove.from.controls<-c() # expand.labels.to.samples(remove.from.controls,control.samples)
remove.from.all.samples<-c() #expand.labels.to.samples(remove.from.all.samples,all.samples)
