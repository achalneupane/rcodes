...
print(file.out.name)
write.table(summary,file=paste(file.out.name,"ALL_GENOTYPES_WITH_SYNON_analysis.txt",sep="."),col.names=TRUE,row.names=FALSE,sep="\t",quote=FALSE)
...
print(file.out.name)
write.table(summary.reduced,file=paste(file.out.name,"ALL_GENOTYPES_WITH_SYNON_analysis-maf-filtered.txt",sep="."),col.names=TRUE,row.names=FALSE,sep="\t",quote=FALSE)
