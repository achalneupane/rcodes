...
# project<-"2014-03-05_AML_RSGB_AOGC_Control" # this is the project directory
...
### *** DO NOT PUT UQCCG.data & projecet below *UNLESS* running manualy. Should be set from => /home/mmarshall/PBSHOME/PaulGenotypingPipeline/SubmitAnnotationScript.qsub on CLUSTERE *****
### ******************************************
#UQCCG.data<-"/home/mmarshall/PBSHOME/2014-08-21_ChMND/" # path to project data 
#UQCCG.data<-"/home/mmarshall/PBSHOME/HiSeq/genotyping/" # path to project data 
...
#project<-"2014-09-18_AML_CompleteGenomics_UG" # this is the project directory
#project<-"2014-09-19_SKDP_SDDS_EDSJ_EDJH_Nextera" # this is the project directory
...
### READ IN THE VARIABLE FROM THE qsub script
...
print(paste(" UQGGC.data-> ",UQCCG.data, ", project-> ",project,sep=" "))
#q()
...
colnames(pot.genes)<-c("Potassium")
  ...
  # save(list=c("ALS","omim","ingenuity.bone.genes","Dequeant.cycling","mouse.defect","sewell.cycling","skeletome","lung.genes","pot.genes","HypoMag","ProtonPump"),file=paste(gsub(".txt$","",target),".GeneLists.RData",sep=""))
  save(list=c("omim","ingenuity.bone.genes","Dequeant.cycling","mouse.defect","sewell.cycling","skeletome","lung.genes","pot.genes","HypoMag","ProtonPump"),file=paste(gsub(".txt$","",target),".GeneLists.RData",sep=""))
