...
min.red.cells<-10
min.green.threshold<-50
max.g1.posn<-14000 #6000 10000-1.1 7000-3.1 for ca3 : 20000 before
min.g1.posn<-5000  #2750 5900-1.1 for Ca3 
expected.g1.posn<-9500 # 3000 8200-1.1 for Ca3
max.ObjectTotalIntenCh1<-32000 # used 30000 in past bust is too low sometimes BEST DECIDED after first fit
double.exposure<-FALSE
...
if(robust.shaver > 1){
for( i.shave in 2:robust.shaver){
