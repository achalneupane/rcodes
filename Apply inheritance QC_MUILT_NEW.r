...
project.dir<-"/mnt/UQCCG/Sequencing/Data/Sequence_Genotypes/2015/2015-02-11_LeoPharmFinalAnalysis/2015-02-11_LeoPharmFinalAnalysisRedoChr1" # path to project data 
...
the.sample.sheet<-"/mnt/UQCCG/Sequencing/Data/Sequence_Genotypes/2015/2015-02-11_LeoPharmFinalAnalysis/BAM/LeoPharma_Feb2015.Sample_Sheet_NEW.txt"
...
if(!exists("max.reads")){max.reads<-70000 } # 0- get ALL IN ONE GO  :
## NA get all
## 1000 samples - 10000 
...
allele.min<-max(c(10,as.integer(samples.processing/4)))
}
...
## all.genotypes$"genotypes"[1:2,1:20] ## sum(is.na(all.genotypes$"genotypes"[,45]))
## all.genotypes$"summary.geno.group"[1:2,]
...
## COMMENTED OUT BY MHAIRI - July 2014
#### read plink
...
# Mhairi updated - Feb 2015. The Sample Sheet should not be expected to be in bam dir. Instead it is passed in as a param..
...
related.sheet<-cbind(related,   sample.sheet.full[posns,])
related.sheet[1:5,]
