...
assoc.file<-"cervical_final.assoc.logistic" # "AOGC_HBM_shell_2.evecs"  "AOGC_HBM_650_shell_more.evecs"
#################################################

###########################CASE 2##############################
#work.dir<-"/media/scratch2/DORITHs_WORK/PCA STRANGE"
plot.dir<-"/media/scratch2/Chinese_MND_GWAS"
assoc.file<-"final_result.assoc.logistic" # "AOGC_HBM_shell_2.evecs"  "AOGC_HBM_650_shell_more.evecs"
#################################################

###########################CASE 2##############################
#work.dir<-"/media/scratch2/DORITHs_WORK/PCA STRANGE"
plot.dir<-"/media/scratch2/Scleroderma"
assoc.file<-"scl.assoc.logistic" # "AOGC_HBM_shell_2.evecs"  "AOGC_HBM_650_shell_more.evecs"
bim.file<-"scl_controls.bim" ### bim file - will extract out snps used
#################################################

###########################CASE 2##############################
#work.dir<-"/media/scratch2/DORITHs_WORK/PCA STRANGE"
plot.dir<-"/media/scratch2/GBS"
assoc.file<-"GBS.assoc.assoc.logistic" # "AOGC_HBM_shell_2.evecs"  "AOGC_HBM_650_shell_more.evecs"
