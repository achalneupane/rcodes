...
#UQCCG.data<-"/home/mmarshall/PBSHOME/HiSeq/" ### ROOT directory for projects
...
#restrict.to.projects<- c("75_0119_SKDP")         #AOGC FMHT-N,FTP 
#restrict.to.projects<- c("GroupCall_TGCM-AML")  
