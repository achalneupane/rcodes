...
> 
>
stderr1<--1*(log(ci95.low.1)-log(or1))/1.96
...
Take the difference of the log odds, δ. The standard error of δ is sqrt(SE1^2+SE^2). Then you can obtain a p-value for the ratio z=δ/SE(δ) from the standard normal.
...
or1<-1.2536
ci95.low.1<-1.2477 #  -1*(log(ci95.low.1)-log(or1))/1.96  1*(log(ci95.high.1)-log(or1))/1.96
ci95.high.1<-1.2596
...
ci95.low.2<-1.11                                          
 ...
 ## or1<-c(48.9,1.14,1.32,1.15,1.13,1.35,1.18,1.13,1.23)

 ## ci95.low.1<-c(43.3,1.05,1.22,1.06,1.04,1.24,1.09,1.04,1.14)


                                             
stderr1<--1*(log(ci95.low.1)-log(or1))/1.96
stderr2<--1*(log(ci95.low.2)-log(or2))/1.96
...
stderr2
delta<-abs(or1-or2)
stderrdelta<-sqrt(stderr1**2+stderr2**2)
z<-delta/stderrdelta
...
The standard error of logOR is the square root of the sum of the reciprocals of the frequencies:
...
PARK2
#############################################chr2:166,113,288-166,565,815
genome.build<-"hg18"
plot.dir<-"/media/scratch2/Uveitis"
work.dir<-"/media/scratch2/Uveitis"
rates.dir<-"/media/scratch/Recombination Rates" ##genetic_map_chr1_b36.txt
file.assoc<-"6.Uveitis_combine_new.assoc" ## asscoc data from eigenstrat
target.pval.col<-"LRPVAL.all.imp"
#file.mach2dat <- "All.out" ## mach2dat output
got.ld<-TRUE
file.plink.ld <- "LD_PARK2.ld" ### above plink format get ld status
file.1000G.ld <- "LD_PARK2.1K" 
with.conservation<-FALSE
the.gene <- 6 ; the.chr<-6 ; the.snp<-"rs2849576" ; low.cut<-162325371 ; high.cut<-162621118 ; left.side=TRUE ; ymax.range=6; recomb.high=40
###########################################
RC3H1
#############################################chr2:166,113,288-166,565,815
genome.build<-"hg18"
...
work.dir<-"/media/scratch2/Uveitis"
rates.dir<-"/media/scratch/Recombination Rates" ##genetic_map_chr1_b36.txt
file.assoc<-"1.Uveitis_combine_new.assoc" ## asscoc data from eigenstrat
target.pval.col<-"LRPVAL.B27.pos"
#file.mach2dat <- "All.out" ## mach2dat output
got.ld<-TRUE
file.plink.ld <- "RC3H1.ld" ### above plink format get ld status
file.1000G.ld <- "RC3H1.1K.ld" 
with.conservation<-FALSE
the.gene <- 11 ; the.chr<-1 ; the.snp<-"rs2849576" ; low.cut<-171408861   ; high.cut<-173508861   ; left.side=TRUE ; ymax.range=6; recomb.high=40
###########################################

170481511 --to-bp 172481511
CH4
#############################################chr2:166,113,288-166,565,815
genome.build<-"hg18"
plot.dir<-"/media/scratch2/Uveitis"
work.dir<-"/media/scratch2/Uveitis"
rates.dir<-"/media/scratch/Recombination Rates" ##genetic_map_chr1_b36.txt
file.assoc<-"4.Uveitis_combine_new.assoc" ## asscoc data from eigenstrat
target.pval.col<-"LRPVAL.all.imp"
#file.mach2dat <- "All.out" ## mach2dat output
got.ld<-TRUE
file.plink.ld <- "ch4.ld" ### above plink format get ld status
file.1000G.ld <- "chr4.1K.ld" 
with.conservation<-FALSE
the.gene <- 11 ; the.chr<-4 ; the.snp<-"rs403730" ; low.cut<-171200000   ; high.cut<-172308861   ; left.side=TRUE ; ymax.range=6; recomb.high=40
###########################################
SLC
...
#file.mach2dat <- "All.out" ## mach2dat output
got.ld<-TRUE
file.plink.ld <- "slc.ld" ### above plink format get ld status
file.1000G.ld <- "slc.1K.ld"
with.conservation<-FALSE
the.gene <- 12 ; the.chr<-1 ; the.snp<-"rs6670304" ; low.cut<-75300000    ; high.cut<-76300000   ; left.side=TRUE ; ymax.range=6; recomb.high=40
###########################################
...
work.dir<-"/media/scratch2/Uveitis"
rates.dir<-"/media/scratch/Recombination Rates" ##genetic_map_chr1_b36.txt
file.assoc<-"3.Uveitis_combine_new.assoc" ## asscoc data from eigenstrat
target.pval.col<-"LRPVAL.all.imp"
#file.mach2dat <- "All.out" ## mach2dat output
got.ld<-TRUE
file.plink.ld <- "chl1.ld" ### above plink format get ld status
file.1000G.ld <- "chl1.1K.ld"
with.conservation<-FALSE
the.gene <- 12 ; the.chr<-3 ; the.snp<-"rs2648465" ; low.cut<-50000    ; high.cut<-450000   ; left.side=TRUE; ymax.range=6; recomb.high=40
###########################################
...
work.dir<-"/media/scratch2/Uveitis"
rates.dir<-"/media/scratch/Recombination Rates" ##genetic_map_chr1_b36.txt
file.assoc<-"9.Uveitis_combine_new.assoc" ## asscoc data from eigenstrat
target.pval.col<-"LRPVAL.all.imp"
#file.mach2dat <- "All.out" ## mach2dat output
got.ld<-TRUE
file.plink.ld <- "chr9.ld" ### above plink format get ld status
file.1000G.ld <- "chr9.1K.ld"
with.conservation<-FALSE
the.gene <- 13 ; the.chr<-9 ; the.snp<-"rs1482071" ; low.cut<-28600000    ; high.cut<-29650000   ; left.side=TRUE; ymax.range=6; recomb.high=40
###########################################
...
#file.mach2dat <- "All.out" ## mach2dat output
got.ld<-TRUE
file.plink.ld <- "rcl11.ld" ### above plink format get ld status
file.1000G.ld <- "rcl1l.1K.ld"
with.conservation<-FALSE
the.gene <- 14 ; the.chr<-9 ; the.snp<-"rs1537146" ; low.cut<-4700000    ; high.cut<-4900000   ; left.side=TRUE; ymax.range=6; recomb.high=40
###########################################

snp rs6590820 --ld-window-r2 0 --ld-window-kb 100000  --ld-window 99999 --out ARHGAP42.1K
#############################################chr2:166,113,288-166,565,815  rs6670304
genome.build<-"hg18"
plot.dir<-"/media/scratch2/Uveitis"
work.dir<-"/media/scratch2/Uveitis"
rates.dir<-"/media/scratch/Recombination Rates" ##genetic_map_chr1_b36.txt
file.assoc<-"11.Uveitis_combine_new.assoc" ## asscoc data from eigenstrat
target.pval.col<-"LRPVAL.all.imp"
#file.mach2dat <- "All.out" ## mach2dat output
got.ld<-TRUE
file.plink.ld <- "ARHGAP42.ld" ### above plink format get ld status
file.1000G.ld <- "ARHGAP42.1K.ld"
with.conservation<-FALSE
the.gene <- 15 ; the.chr<-11 ; the.snp<-"rs6590820" ; low.cut<-99800000    ; high.cut<-100300000   ; left.side=TRUE; ymax.range=6; recomb.high=40
###########################################
# the gene a label used in files names etc
 ###
plink --bfile imp --r2 --ld-snp rs504372 --ld-window-r2 0 --ld-window-kb 100000  --ld-window 99999 --out PGR.1K
#############################################chr2:166,113,288-166,565,815  rs6670304
genome.build<-"hg18"
...
#file.mach2dat <- "All.out" ## mach2dat output
got.ld<-TRUE
file.plink.ld <- "PGR.ld" ### above plink format get ld status
file.1000G.ld <- "PGR.1K.ld"
with.conservation<-FALSE
the.gene <- 16 ; the.chr<-11 ; the.snp<-"rs504372" ; low.cut<-100300000    ; high.cut<-100600000   ; left.side=FALSE; ymax.range=8; recomb.high=40
###########################################
...
work.dir<-"/media/scratch2/Uveitis"
rates.dir<-"/media/scratch/Recombination Rates" ##genetic_map_chr1_b36.txt
file.assoc<-"16.Uveitis_combine_new.assoc" ## asscoc data from eigenstrat
target.pval.col<-"LRPVAL.all.imp"
#file.mach2dat <- "All.out" ## mach2dat output
got.ld<-TRUE
file.plink.ld <- "chr16.ld" ### above plink format get ld status
file.1000G.ld <- "chr16.1K.ld"
with.conservation<-FALSE
the.gene <- 17 ; the.chr<-16 ; the.snp<-"rs7187327" ; low.cut<-72610000    ; high.cut<-72770000   ; left.side=FALSE; ymax.range=6; recomb.high=40
###########################################
...
#file.mach2dat <- "All.out" ## mach2dat output
got.ld<-TRUE
file.plink.ld <- "CDH13.ld" ### above plink format get ld status
file.1000G.ld <- "CDH13.1K.ld"
with.conservation<-FALSE
the.gene <- 17 ; the.chr<-16 ; the.snp<-"rs8052043" ; low.cut<-81800000    ; high.cut<-82200000   ; left.side=FALSE; ymax.range=6; recomb.high=40
###########################################
plink --bfile imp --r2 --ld-snp rs2836760 --ld-window-r2 0 --ld-window-kb 100000  --ld-window 99999 --out chr21.1K
...
work.dir<-"/media/scratch2/Uveitis"
rates.dir<-"/media/scratch/Recombination Rates" ##genetic_map_chr1_b36.txt
file.assoc<-"21.Uveitis_combine_new.assoc" ## asscoc data from eigenstrat
target.pval.col<-"LRPVAL.all.imp"
#file.mach2dat <- "All.out" ## mach2dat output
got.ld<-TRUE
file.plink.ld <- "chr21.ld" ### above plink format get ld status
file.1000G.ld <- "chr21.1K.ld"
with.conservation<-FALSE
the.gene <- 18 ; the.chr<-21 ; the.snp<-"rs2836760" ; low.cut<-39000000    ; high.cut<-39300000   ; left.side=TRUE; ymax.range=6; recomb.high=40
###########################################
...
#file.mach2dat <- "All.out" ## mach2dat output
got.ld<-TRUE
file.plink.ld <- "chr6B27.ld" ### above plink format get ld status
file.1000G.ld <- "chr6B27.1K.ld"
with.conservation<-FALSE
the.gene <- 19 ; the.chr<-6 ; the.snp<-"rs9444597" ; low.cut<-88900000    ; high.cut<-89200000   ; left.side=TRUE; ymax.range=6; recomb.high=40
###########################################
...
work.dir<-"/media/scratch2/Uveitis"
rates.dir<-"/media/scratch/Recombination Rates" ##genetic_map_chr1_b36.txt
file.assoc<-"10.Uveitis_combine_new.assoc" ## asscoc data from eigenstrat
target.pval.col<-"LRPVAL.B27.pos"
#file.mach2dat <- "All.out" ## mach2dat output
got.ld<-TRUE
file.plink.ld <- "chr10B27.ld" ### above plink format get ld status
file.1000G.ld <- "chr10B27.1K.ld"
with.conservation<-FALSE
the.gene <- 20 ; the.chr<-10 ; the.snp<-"rs4748516" ; low.cut<-19020000    ; high.cut<-19200000   ; left.side=FALSE; ymax.range=6; recomb.high=40
###########################################
