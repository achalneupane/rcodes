...
## ann<-read.table(annotation.file,header=T,fill=TRUE,sep="\t",stringsAsFactors=FALSE)
contaminated.file<-c() # COLL-FAM-1.201,COLL-FAM-1.3
contaminated<-c()
...
save(list=c("a.indel"),file="LEO_Pharma_wanted_with_synon_ALL_0.01_muts_Feb23" )
...
## test<-c("SETD8")
net<-c("BCL2L12","KNSTRN","ISX","CDKN2A","BCL2L11","STK19","FJX1")
