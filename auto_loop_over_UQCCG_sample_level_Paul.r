...
## [1] "SKDP-3.3 NOT combined running"
##                SKDP-3.3_C1KGGACXX-2-07.ReCal.sort.bam 
## "SKDP-3.3_C1KGGACXX-2-07.ReCal.sort.QC.regions.RData" 
##                SKDP-3.3.ReCal.sort.bam 
## "SKDP-3.3.ReCal.sort.QC.regions.RData" 
## Error in data.frame(..., check.names = FALSE) : 
##   arguments imply differing number of rows: 33, 26
