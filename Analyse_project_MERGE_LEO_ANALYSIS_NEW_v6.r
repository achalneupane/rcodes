...
snap.file<-paste(snap.file,".withGQ.filter.QCed_weights",sep="")
snap.file
...
file<-"/media/UQCCG/Sequencing/Data/Sequence_Genotypes/2015/2015-02-11_LeoPharmFinalAnalysis/Analysis/Burden.ALL.coding.somatic.with.Indels.noBenign.wRepeats.withGQ.filter.QCed_weights_possonian_rescue_6sd.txt"
...
z[!is.na(z)]
the.plot<-my.qq.plot(z,dist="chisq",df=1,ncp=0,col="blue",ylab="Observed chi-squared value",xlab="Expected chi-squared value",main="",cex=1,xlim=c(0,22),ylim=c(0,120),cex.lab=2.0,cex.axis=2.0,font.lab=2,font.axis=2,lwd=2,line="robust",plot.it=TRUE) # function defined below
...
interesting<-c("TP53","NOTCH1","NOTCH2","FAT1","STK19","TRHDE","KNSTRN","BCL2L12")
show<-symbols[qq$ord] %in% interesting
points(qq$x[show],qq$y[show],col="magenta",pch=20)
text(qq$x[show],qq$y[show],labels=symbols[qq$ord[show]],col="red",pos=2,offset=0.5)  #,pch=25)
