...
setwd(analysis.dir)
################## fast read ###########  load("/media/UQCCG/Sequencing/Data/Sequence_Genotypes/2015/2015-02-11_LeoPharmFinalAnalysis/Analysis/indels.RData")
...
types<-c("coding.somatic","coding.somatic.with.Indels","coding.somatic.with.Indels.noBenign","coding.somatic.with.Indels.noBenign.wRepeats","coding.somatic.with.repeats")

s.missense<-missense.coding.vep | missense.coding
...
## pass.coding.somatic.with.Indels
## pass.coding.somatic.with.Indels.noBenign
## pass.coding.somatic.with.Indels.noBenign.wRepeats

## summary.geno.extra.keep<-summary.geno.extra[keep,]
## a.indel.keep<-a.indel[keep,]

## save(list=c("a.indel.keep","summary.geno.extra.keep","pass.coding.somatic.with.Indels","pass.coding.somatic.with.Indels.noBenign","pass.coding.somatic.with.Indels.noBenign.wRepeats"),file="LEO_Pharma_WANTED_SUBSET_0.01_muts_Feb23" )

##  rm("a.indel.keep")
##  rm("summary.geno.extra.keep")


save.image(file=paste("LEO_Pharma_WANTED_0.01_muts_Feb23",".RData",sep=""))
...
snap.file<-"somatic.coding.0.001.snpOLNY"
...
out<-cbind(meta.results.burden.ex,annotations[figure,],summary.geno.extra[figure,colnames(summary.geno.extra)[grep("^GENO",colnames(summary.geno.extra))]],help[figure,],muts.in.cases,quality.cases,depth.cases,muts.in.controls,quality.controls,depth.controls)
